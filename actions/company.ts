...
export async function createCompany(formData: FormData) {
  ...
  console.log(name, email, about, foundationYear, website, industry, logoUrl, recruiterId)
  
  const result = companyInfoSchema.safeParse({ name, email, about, foundationYear, website, industry, logoUrl })
  if(!result.success) {
    return {
